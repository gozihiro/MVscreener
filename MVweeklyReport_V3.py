...
def create_intelligence_report(df):
    ...
    <head>
        ...
        <style>
            ...
            .launchpad-high {{ color: #f39c12; font-weight: bold; }}
        </style>
    </head>
    <body>
        <div class="container">
        ...
        <script>
            ...
            datePicker.max = sortedDates[sortedDates.length - 2].replace(/\//g, '-');
            ...
            function updateDashboard(targetDates) {{
                ...
                const analyzed = data.stocks.map(s => {{
                    ...
                    let growth = 0, pattern = "データ不足", launchpad = 0;
                    ...
                    sec.data.forEach((s, idx) => {{
                        ...
                        <div class="rank-card">
                            ...
                            <div class="metric-box">
                                <div class="metric-row"><span>発射台Score</span> <b class="launchpad-high">${{s.launchpad.toFixed(1)}}</b></div>
